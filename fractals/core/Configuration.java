...
public class Configuration
{
    ...
    public Configuration(Complex min, Complex max, int widthHeight, int iterationRange, Variant variant, Optional<Complex> variant_parameter) {
        this.min = min;
        this.max = max;
    ...
    public static class Builder 
    {
        ...
        public Configuration build() {
            return new Configuration(min, max, widthHeight, iterationRange, variant, variant_parameter);
        }
